 ...
 * @detailed
 * <ul>
 *   <li><b>true</b> </li>- uses absolute paths. For example: url(http://anychart.com/chart.html?query=param##ac_clip_1).
 *   <li><b>false</b> </li>- uses relative paths. For example: url(##ac_clip_1).
 *   <li><b>null</b> </li>- auto detects paths (if exists <base> tag, use absolute paths)
 * </ul>
...
/**
 * Update all paths to svg defs.</br>
