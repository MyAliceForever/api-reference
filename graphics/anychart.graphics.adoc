 ...
 * @detailed
 * <ul>
 * <b>true</b> - uses absolute paths. For example: url(http://anychart.com/chart.html?query=param##ac_clip_1).
 * <b>false</b> - uses relative paths. For example: url(##ac_clip_1).
 * <b>null</b> - auto detects paths (if exists <base> tag, use absolute paths)
 * </ul>
