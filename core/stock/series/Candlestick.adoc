...
/**
 * Sets rising fill settings using string.
 * {docs:Graphics/Hatch_Fill_Settings}Learn more about hatch fill settings.{docs}
 * @example anychart.core.stock.series.Candlestick.risingFill_set_asString
...
/**
 * Sets rising fill settings in hover mode using string.
...
/**
 * Sets falling fill settings using a string.
 * {docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
